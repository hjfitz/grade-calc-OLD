...
function updateGrades() {
	...
	try {
		...
		gpa.textContent = calculated.gpa
		overall.textContent = calculated.overall
...
function addUnit(form) {
	return () => {
		...
		<td><input data-type="credits" type="number" class="form-input" placeholder="Credits" min="5" max="120" value="20" /></td>`
		...
		remove.classList = 'btn btn-primary'
		remove.innerHTML = '<i class="icon icon-cross"></i>'
