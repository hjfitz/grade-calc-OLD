...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var r=require("lodash/lang"),e=require("lodash/array");function t(r,e){return u(r)||a(r,e)||n()}function n(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function a(r,e){var t=[],n=!0,a=!1,u=void 0;try{for(var o,i=r[Symbol.iterator]();!(n=(o=i.next()).done)&&(t.push(o.value),!e||t.length!==e);n=!0);}catch(l){a=!0,u=l}finally{try{n||null==i.return||i.return()}finally{if(a)throw u}}return t}function u(r){if(Array.isArray(r))return r}var o=function(r,e){return r.grade>e.grade?1:r.grade<e.grade?-1:0};function i(r){var e=r.sort(o);return e.splice(0,4),e}function l(r){return r.map(function(r){return parseInt(r.grade,10)}).reduce(function(r,e){return r+e},0)/r.length}function d(r){var t=r.map(function(r){for(var e=r.grade,t=r.credits,n=t/5,a=[],u=0;u<n;u+=1)a.push({grade:e,credits:5,originalCredits:t});return a});return(0,e.flatten)(t)}var c=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];return 240!==r.concat(e).reduce(function(r,e){return r+parseInt(e.credits,10)},0)};function s(){for(var r=arguments.length,e=new Array(r),n=0;n<r;n++)e[n]=arguments[n];var a=t(e.sort().reverse(),1)[0];return a>74?4.25:a>70?4:a>66?3.75:a>63?3.5:a>60?3.25:a>56?3:a>53?2.75:a>49?2.5:a>47?2.25:a>42?2:a>39?1.5:a>37?1:a>34?.75:a>29?.5:0}function f(){for(var r=arguments.length,e=new Array(r),n=0;n<r;n++)e[n]=arguments[n];var a=t(e.sort().reverse(),1)[0];return a>69?"1st":a>59?"2:1":a>49?"2:2":a>38.5?"3rd":"3rd (No honours)"}function v(r,n){if(c(r,n))throw new Error("Invalid credits! Must equal 120 per year!");var a=t([r,n].map(d).map(i),2),u=a[0],v=a[1],p=t([u,v].map(l),2),g=p[0],h=p[1],y={};y.rule1=(.4*g+.6*h).toFixed(3),y.rule2=h.toFixed(3);var m=u.concat(v).map(function(r){var e=r.originalCredits;return{name:r.name,grade:r.grade,credits:e}}).map(JSON.stringify),w=(0,e.uniq)(m).map(JSON.parse).sort(o);return y.rule3=parseInt(w[3].grade,10).toFixed(3),y.gpa=s(y.rule1,y.rule2,y.rule3),y.overall=f(y.rule1,y.rule2,y.rule3),y}var p=v;exports.default=p;
